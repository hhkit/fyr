...
\begin{itemize}
  \item RQ1: Can we exploit hardware-accelerated pipelines in the GPU to accelerate linear algebra operations?
  \item RQ2: Does declaratively expressing render pipelines as a high-level programming language enable whole program optimization?
  \item RQ3: 
\end{itemize}
\end{abstract}
