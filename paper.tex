...
RQ1 will be addressed by the raytracing paper, as we apply compiler techniques to not only apply the raytracing pipeline to sparse linear algebra, but fuse adjacent computations into the loop as well. Success will be determined by how our compiler-based solution holds up against the state of the art sparse linear algebra libraries such as cuSPARSE\cite{CuSPARSE} and MAGMA\cite{abdelfattahMAGMAEnablingExascale2024}, comparing the metrics in terms of performance and maintainability.
